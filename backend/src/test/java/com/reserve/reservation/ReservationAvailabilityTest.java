...
class ReservationAvailabilityTest {
    ...
    @Mock
    private com.reserve.payment.service.PaymentService paymentService;

    @Mock
    private com.reserve.email.service.EmailService emailService;

    @Mock
    private com.reserve.member.repository.MemberRepository memberRepository;

    @Mock
    private com.reserve.audit.service.AuditLogService auditLogService;
